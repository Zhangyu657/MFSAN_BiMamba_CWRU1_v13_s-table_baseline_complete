...
# 新建一个目录，避免覆盖旧的 9 类数据集
OUT_ROOT = "/workspace/PU_TL_9_replace/PU"
...
# 9-class PU setting: replace KB27/KI18 with KB23/KI16
CLASSES = ["K001", "KA04", "KA16", "KA30", "KB24", "KB23", "KI04", "KI17", "KI16"]
...
def main():
    ...
    print("/workspace/PU_TL_9_replace")
